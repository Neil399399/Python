...
def CNN_Model(Image, Image_height, Image_width, Conv1_Filter, Conv2_Filter, Pool_Size, Padding, Activation_Function, output_layer_units):
    # CNN.
    output_shape = (Image_height/Pool_Size**3)*(Image_width/Pool_Size**3)*216
    ...
    conv3 = tf.layers.conv2d(pool2, 216, 5, 1, Padding, activation=Activation_Function,name='conv3')    
